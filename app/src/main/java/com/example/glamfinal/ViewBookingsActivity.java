    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userPhoneNumber != null) {
            if (isAdmin) {
                ...
                bookingsRef = FirebaseDatabase.getInstance().getReference("Bookings").child(userPhoneNumber);
            }
            fetchBookings();
        }
    }
    ...
    private void fetchBookings() {
        ...
        bookingsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (isAdmin) {
                    for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                        ...
                        for (DataSnapshot bookingSnapshot : userSnapshot.getChildren()) {
                            ...
                            if (booking != null) {
                                booking.setPhoneNumber(phoneNumber); // Set the correct phone number associated with the booking
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        if (booking != null) {
                            // Ensure the correct phone number associated with the booking is set
                ...
                if (adapter == null) {
                    adapter = new BookingAdapter(bookings, ViewBookingsActivity.this,false);
